    ...
    for step, batch in tqdm(
        ...
        with torch.no_grad():
            ...
            if use_fiddler or simulation_model is not None:
                # Fiddler/Simulation model: direct generate call, no accelerator
                ...
                generated_tokens = model.generate(
                    ...
                    stopping_criteria=gen_kwargs.get("stopping_criteria", None),
                )
            elif "ids_encoder" in batch:
                if is_wrapped:
            ...
            if use_fiddler:
                # Fiddler: skip accelerator gather/pad
