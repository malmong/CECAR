...
class MLCacheV2:
    ...
    def init_eviction_models(self):
        ...
        config_path = f"../../Evaluation/fiddler_model/Config/DeepSeek_v2_Lite_Chat_config.json"
        ...
        self.first_k_dense_replace = ffn_config.get('first_k_dense_replace', 1)
        ...
        expected_moe_layers = self.n_layers
