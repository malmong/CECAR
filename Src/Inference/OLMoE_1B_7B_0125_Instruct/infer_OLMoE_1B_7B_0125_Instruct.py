...
from OLMoE_1B_7B_0125_Instruct import FiddlerOlmoe
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="../../Build/models/OLMoE_1B_7B_0125_Instruct/non_expert",
        help="Base model path (non-expert weights).",
    )
    parser.add_argument(
        "--expert_path",
        type=str,
        default="../../Build/models/OLMoE_1B_7B_0125_Instruct/experts",
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Input text to generate (ignored if --test-task is set).",
    )
    parser.add_argument(
        "--test-task",
        type=str,
    ...
    parser.add_argument("--compute_k", type=int, default=8, help="Ablation: experts computed among routed.")
    parser.add_argument(
        "--ffn-model-path",
        type=str,
        default="../../Train/Pre_trained_FFN/OLMoE_1B_7B_0125_Instruct/",
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="Index for margin: delta = z_top1 - z[margin_topk_idx].",
    )
    ...
    parser.add_argument(
        "--des-thresholds-path",
        type=str,
        default="../../Evaluation/fiddler_model/MCMOE/OLMoE_1B_7B_0125_Instruct_mmlu_ccsc_top4_6_thresholds.json",
...
def normalize_args(args: argparse.Namespace) -> argparse.Namespace:
    ...
    if args.test_task is not None:
        ...
        args.des_thresholds_path = os.path.join(
            ...
            f"OLMoE_1B_7B_0125_Instruct_{stem}_top4_6_thresholds.json",
        )
